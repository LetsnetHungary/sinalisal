<?
    ...
    class Auth_Model extends CoreApp\Model {
      ...
      public function __construct() {
        ...
        $this->id = CoreApp\AppConfig::getAuthData()->appid;
        $this->keepmeloggedinurl = CoreApp\AppConfig::getAuthData()->keepmeloggedinURL.$this->id;
        $this->loginurl = CoreApp\AppConfig::getAuthData()->loginURL.$this->id;
        $this->logouturl =  CoreApp\AppConfig::getAuthData()->logoutURL.$this->id;
        $this->checkurl = \CoreApp\AppConfig::getAuthData()->checkIfLoggedInURL.$this->id;
      }
